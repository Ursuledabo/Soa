...
exports.testAdd100RandomMedoc = exports.getMedocsByPharmacyAndName = exports.getMedocsByPharmacy = exports.getMedocs = exports.getMedoc = exports.updateMedoc = exports.deleteMedoc = exports.addMedoc = void 0;
...
const testAdd100RandomMedoc = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const medocPharmacyId = req.params.medocPharmacyId;
    const pharmacy = yield Pharmacy_1.default.findById(medocPharmacyId);
    if (pharmacy)
        try {
            for (let i = 0; i < 100; i++) {
                const newMedoc = new Medodc_1.default({
                    medocName: "medoc" + i,
                    medocPrice: Math.random() * 100000,
                    medocQuantity: i,
